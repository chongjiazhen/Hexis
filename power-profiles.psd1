...
@{
    ...
    BigModels = @{
        ...
        # worldsim retired 2026-05-19: GGUF offloaded for disk space, snapshot
        # lifecycle owned by llm-serve. Re-add an entry (with a live local
        # Path, NOT bare Repo -> Xet-hang wedge) if it returns as an ActiveBig.
    }
